<!DOCTYPE html>
<html lang="en">
<?= $this->include('layouts/common/header', ['title' => '注册']) ?>
<style>
  .father {
    width: 1000px;
    height: auto;
...
<div class="father">
  <div class="login-main">
    <p style="color:#009688;font-size:25px;text-align:center;">欢迎注册 ~
    ...
    <form class="layui-form">
      ...
      <p>
        <a href="/views/login" class="fl">立即登录</a>
      </p>
    </form>
  </div>
</div>
<script type="module">
  import {static_user_login, user_register} from '/service/js/api.js';
