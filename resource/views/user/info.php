...
<?= $this->include('layouts/common/header', ['title' => '个人资料']) ?>
<body>
...
<script type="module">
  import {user_info, user_change_name_info} from '/service/js/api.js';
  import {getRequest, postRequest} from '/service/js/request.js';
  ...
  layui.use(['form', 'laydate'], function () {
    ...
    layui.use(['laydate', 'form', 'laytpl'], function () {
      ...
      form.on("submit(save)", function (data) {
        postRequest(user_change_name_info, data.field, function (result) {
